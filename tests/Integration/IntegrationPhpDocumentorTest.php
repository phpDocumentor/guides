...
class IntegrationPhpDocumentorTest extends ApplicationTestCase
{
    protected function setUp(): void
    {
        self::prepareContainer(new Configuration([
            __DIR__ . '/../../packages/guides-theme-phpdocumentor/resources/template',
    ...
    {
        return self::getTestsForDirectory('/tests-phpdocumentor');
    }
