...
final class SpecificationFactoryTest extends TestCase
{
    ...
    public function testCreateIgnorePath(): void
    {
        $specification = $this->fixture->create(
            ['/src/'],
            new Exclude(['/src/some/path', '/src/some/other/path']),
            ['php'],
        );
    ...
    {
        $specification = $this->fixture->create([], new Exclude(['/src/some/path']), ['php']);
    ...
    {
        $specification = $this->fixture->create(['/src/'], new Exclude(), ['php']);
