...
final class InlineLexer extends AbstractLexer
{
    ...
    protected function getCatchablePatterns(): array
    {
        return [
            ...
            self::SUPPORTED_SCHEMAS . ':[-a-zA-Z0-9()@:%_\\+.~#?&\\/=]*[-a-zA-Z0-9()@%_\\+~#&\\/=]', // standalone hyperlinks
            '\\S+@\\S+\\.\\S+',
    ...
    protected function getType(string &$value)
    {
        ...
        if (preg_match('/' . self::SUPPORTED_SCHEMAS . ':[-a-zA-Z0-9()@:%_\\+.~#?&\\/=]*[-a-zA-Z0-9()@%_\\+~#&\\/=]/', $value) && parse_url($value, PHP_URL_SCHEME) !== null) {
